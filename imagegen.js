...
module.exports = (client, args) => {
  ...
  client.on("message", async (message) => {
    if (message.content.startsWith(prefix + 'delete')) {
    ...
    } else if (message.content.startsWith(prefix + 'affect')) {
    ...
    } else if (message.content.startsWith(prefix + 'trash')) {
    ...
    } else if (message.content.startsWith(prefix + 'batslap')) {
    ...
    } else if (message.content.startsWith(prefix + 'stonk')) {
    ...
    } else if (message.content.startsWith(prefix + 'lisapresentation')) {
    ...
    } else if (message.content.startsWith(prefix + 'bed')) {
    ...
    } else if (message.content.startsWith(prefix + 'spank')) {
    ...
    } else if (message.content.startsWith(prefix + 'notstonks')) {
    ...
    } else if (message.content.startsWith(prefix + 'M&Ms')) {
      ...
      } else if (message.content.startsWith(prefix + 'hitler')) {
